...
class _PcConfigAdminLoginScreenState extends State<PcConfigAdminLoginScreen>
  ...
  Future<void> _loadServerUrl() async {
    _serverUrlCtrl.text = await AppConfigService.instance.getServerUrl();
  }
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (!mounted) return;
      _showError(error.toString().replaceFirst('Exception:', '').trim());
    } finally {
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(color: _textColor.withValues(alpha: 0.45), fontSize: 13, height: 1.5),
          ),
          ...
          TextButton.icon(
            ...
            icon: Icon(Icons.arrow_back_rounded, size: 16, color: _textColor.withValues(alpha: 0.35)),
            label: Text('Go back', style: TextStyle(color: _textColor.withValues(alpha: 0.35), fontSize: 13)),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [_accentA.withValues(alpha: 0.15), _accentB.withValues(alpha: 0.10)],
      ...
      child: Row(
        children: [
          Padding(
            ...
            child: Icon(icon, color: _accentA.withValues(alpha: 0.75), size: 18),
          ),
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                labelText: label,
                labelStyle: TextStyle(color: _textColor.withValues(alpha: 0.40), fontSize: 13),
                floatingLabelStyle: TextStyle(color: _accentA.withValues(alpha: 0.80), fontSize: 12),
    ...
    return _FieldShell(
      ...
      child: Row(
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 14),
            child: Icon(Icons.lock_outline_rounded, color: _accentA.withValues(alpha: 0.75), size: 18),
          ),
          Expanded(
            child: TextField(
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Icon(
                ...
                color: _textColor.withValues(alpha: 0.30), size: 18,
              ),
            ),
          ),
        ],
  ...
  Widget _buildLoginButton() {
    return SizedBox(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          gradient: _loading ? null : const LinearGradient(colors: [_accentA, _accentB]),
        ...
        child: ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: _loading ? _fieldColor : Colors.transparent,
            shadowColor: Colors.transparent,
            foregroundColor: _loading ? _textColor.withValues(alpha: 0.40) : const Color(0xFF080A0E),
          ...
          icon: _loading
            ...
            child: CircularProgressIndicator(strokeWidth: 2, color: _textColor.withValues(alpha: 0.40)),
              ...
              : const Icon(Icons.settings_applications_rounded, size: 19),
          label: Text(
            _loading ? 'Connecting…' : 'Open PC Configuration',
